...
$password = '';
if (isset($attrs['seciossEncryptedPassword']) && $attrs['seciossEncryptedPassword'] && $attrs['seciossEncryptedPassword'] !== ' ') {
...
$passphrase = '';
$publick_key = '';
if (isset($attrs['seciossEncryptedPrivateKey']) && $attrs['seciossEncryptedPrivateKey'] && $attrs['seciossEncryptedPrivateKey'] !== ' ') {
